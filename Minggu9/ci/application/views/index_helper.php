...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <!-- Bootstrap core JS-->
        <script src="<?=base_url();?>https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
        <script src="<?=base_url();?>https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js"></script>
